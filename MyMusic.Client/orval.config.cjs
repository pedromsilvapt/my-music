            ...
            override: {
                ...
                query: {
                    ...
                    mutationInvalidates: [
                        ...
                        {
                            onMutations: ['replaceQueue', 'addToQueue', 'removeFromQueue', 'reorderQueue', 'shuffleQueue', 'setQueueCurrentSong', 'setStopAfterPlayback', 'batchSetStopAfterPlayback', 'setSkipNextPlayback', 'batchSetSkipNextPlayback'],
