...
>(
	...
	const queryFn: QueryFunction<Awaited<ReturnType<typeof listWishlist>>> = ({
		signal,
	}) => listWishlist(params, { signal, ...fetchOptions });
...
export function useListWishlist<
	...
	TError = unknown,
>(
	params: undefined | ListWishlistParams,
	options: {
		query: Partial<
			UseQueryOptions<Awaited<ReturnType<typeof listWishlist>>, TError, TData>
		> &
...
export const invalidateListWishlist = async (
	...
	await queryClient.invalidateQueries(
		{ queryKey: getListWishlistQueryKey(params) },
		options,
	);
...
export const useCreateWishlist = <TError = unknown, TContext = unknown>(
	options?: {
		mutation?: UseMutationOptions<
			Awaited<ReturnType<typeof createWishlist>>,
			TError,
...
> => {
	...
	return useMutation(
		getCreateWishlistMutationOptions(queryClient ?? backupQueryClient, options),
		queryClient,
	);
};
...
export const useUpdateWishlist = <TError = unknown, TContext = unknown>(
	options?: {
		mutation?: UseMutationOptions<
			Awaited<ReturnType<typeof updateWishlist>>,
			TError,
...
> => {
	const backupQueryClient = useQueryClient();
	return useMutation(
		getUpdateWishlistMutationOptions(queryClient ?? backupQueryClient, options),
		queryClient,
	);
};
...
export const useDeleteWishlist = <TError = unknown, TContext = unknown>(
	options?: {
		mutation?: UseMutationOptions<
			Awaited<ReturnType<typeof deleteWishlist>>,
			TError,
...
> => {
	const backupQueryClient = useQueryClient();
	return useMutation(
		getDeleteWishlistMutationOptions(queryClient ?? backupQueryClient, options),
		queryClient,
	);
};
...
export const getListWishlistMockHandler = (
	overrideResponse?:
		...
		| ((
		  ...
		  ) => Promise<ListWishlistResponse> | ListWishlistResponse),
...
export const getCreateWishlistMockHandler = (
	overrideResponse?:
		| CreateWishlistResponse
		| ((
				info: Parameters<Parameters<typeof http.post>[1]>[0],
		  ) => Promise<CreateWishlistResponse> | CreateWishlistResponse),
	options?: RequestHandlerOptions,
) => {
	return http.post(
		"*/wishlist",
...
export const getUpdateWishlistMockHandler = (
	overrideResponse?:
		| UpdateWishlistResponse
		| ((
				info: Parameters<Parameters<typeof http.put>[1]>[0],
		  ) => Promise<UpdateWishlistResponse> | UpdateWishlistResponse),
	options?: RequestHandlerOptions,
) => {
	return http.put(
		"*/wishlist/:id",
...
export const getDeleteWishlistMockHandler = (
	overrideResponse?:
		| void
		| ((
