...
export type getLocalSongResponseSuccess = (
	| getLocalSongResponse200TextPlain
	| getLocalSongResponse200ApplicationJson
	| getLocalSongResponse200TextJson
) & {
	headers: Headers;
};
...
export const getLocalSong = async (
	id: number,
	options?: RequestInit,
): Promise<getLocalSongResponse> => {
...
export const getGetLocalSongQueryOptions = <
	TData = Awaited<ReturnType<typeof getLocalSong>>,
	TError = unknown,
>(
	id: number,
	options?: {
		query?: Partial<
			UseQueryOptions<Awaited<ReturnType<typeof getLocalSong>>, TError, TData>
		>;
		fetch?: RequestInit;
	},
) => {
	...
	const queryFn: QueryFunction<Awaited<ReturnType<typeof getLocalSong>>> = ({
		signal,
	}) => getLocalSong(id, { signal, ...fetchOptions });
...
export type GetLocalSongQueryResult = NonNullable<
	Awaited<ReturnType<typeof getLocalSong>>
>;
export type GetLocalSongQueryError = unknown;

export function useGetLocalSong<
	TData = Awaited<ReturnType<typeof getLocalSong>>,
	TError = unknown,
>(
	id: number,
...
export const invalidateGetLocalSong = async (
	...
	await queryClient.invalidateQueries(
		{ queryKey: getGetLocalSongQueryKey(id) },
		options,
	);
...
export const getGetLocalSongResponseGetSongResponseCoverMock = (
...
export const getGetLocalSongResponseGetSongResponseAlbumArtistMock = (
...
export const getGetLocalSongResponseMock = (
	...
	faker.helpers.arrayElement([
		{
			song: {
				...
				coverDetails: faker.helpers.arrayElement([
					faker.helpers.arrayElement([
						null,
						{ ...getGetLocalSongResponseGetSongResponseCoverMock() },
					]),
					undefined,
				]),
				title: faker.string.alpha({ length: { min: 10, max: 20 } }),
				...
				album: {
					...
					artist: faker.helpers.arrayElement([
						faker.helpers.arrayElement([
							null,
							{ ...getGetLocalSongResponseGetSongResponseAlbumArtistMock() },
						]),
						undefined,
					]),
				},
	...
	faker.helpers.arrayElement([
		{
			artists: Array.from(
				...
				albumCount: faker.helpers.arrayElement([faker.number.int(), undefined]),
...
export const getGetLocalSongMockHandler = (
	overrideResponse?:
		| GetSongResponse
		| ((
				info: Parameters<Parameters<typeof http.get>[1]>[0],
