...
export type getArtworkResponseComposite = getArtworkResponse200;

export type getArtworkResponse = getArtworkResponseComposite & {
	headers: Headers;
};
...
export const getGetArtworkMockHandler = (
	...
	return http.get("*/Artwork/:id", async (info) => {
		await delay(1000);
