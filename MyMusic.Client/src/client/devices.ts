...
>(
	...
	const queryFn: QueryFunction<Awaited<ReturnType<typeof getDevice>>> = ({
		signal,
	}) => getDevice(deviceId, { signal, ...fetchOptions });
...
export type getDevicesDeviceIdSessionsSessionIdRecordsFilterMetadataResponse =
	getDevicesDeviceIdSessionsSessionIdRecordsFilterMetadataResponseSuccess;

export const getGetDevicesDeviceIdSessionsSessionIdRecordsFilterMetadataUrl = (
	deviceId: number,
	sessionId: number,
) => {
...
export const getDevicesDeviceIdSessionsSessionIdRecordsFilterMetadata = async (
	deviceId: number,
	sessionId: number,
	options?: RequestInit,
): Promise<getDevicesDeviceIdSessionsSessionIdRecordsFilterMetadataResponse> => {
	const res = await fetch(
		getGetDevicesDeviceIdSessionsSessionIdRecordsFilterMetadataUrl(
			deviceId,
			sessionId,
		),
		{
	...
	const data: getDevicesDeviceIdSessionsSessionIdRecordsFilterMetadataResponse["data"] =
		body ? JSON.parse(body) : {};
	return {
		data,
		status: res.status,
		headers: res.headers,
	} as getDevicesDeviceIdSessionsSessionIdRecordsFilterMetadataResponse;
};

export const getGetDevicesDeviceIdSessionsSessionIdRecordsFilterMetadataQueryKey =
	(deviceId: number, sessionId: number) => {
		return [
			"api",
			"devices",
...
export const getGetDevicesDeviceIdSessionsSessionIdRecordsFilterMetadataQueryOptions =
	<
		TData = Awaited<
			ReturnType<
				typeof getDevicesDeviceIdSessionsSessionIdRecordsFilterMetadata
			>
		>,
		TError = unknown,
	>(
		...
		const queryKey =
			queryOptions?.queryKey ??
			getGetDevicesDeviceIdSessionsSessionIdRecordsFilterMetadataQueryKey(
				deviceId,
				sessionId,
			);
		...
		const queryFn: QueryFunction<
			...
			>
		> = ({ signal }) =>
			getDevicesDeviceIdSessionsSessionIdRecordsFilterMetadata(
				deviceId,
				sessionId,
				{ signal, ...fetchOptions },
			);
...
export type GetDevicesDeviceIdSessionsSessionIdRecordsFilterMetadataQueryResult =
	NonNullable<
		Awaited<
			ReturnType<
				typeof getDevicesDeviceIdSessionsSessionIdRecordsFilterMetadata
		...
		>
	>;
export type GetDevicesDeviceIdSessionsSessionIdRecordsFilterMetadataQueryError =
	unknown;

export function useGetDevicesDeviceIdSessionsSessionIdRecordsFilterMetadata<
	TData = Awaited<
		ReturnType<typeof getDevicesDeviceIdSessionsSessionIdRecordsFilterMetadata>
	>,
	TError = unknown,
>(
	deviceId: number,
...
>(
	...
	const queryOptions =
		getGetDevicesDeviceIdSessionsSessionIdRecordsFilterMetadataQueryOptions(
			deviceId,
			sessionId,
			options,
		);
...
export const invalidateGetDevicesDeviceIdSessionsSessionIdRecordsFilterMetadata =
	async (
		queryClient: QueryClient,
		deviceId: number,
		sessionId: number,
...
export type getDevicesDeviceIdSessionsSessionIdRecordsFilterValuesResponse =
	getDevicesDeviceIdSessionsSessionIdRecordsFilterValuesResponseSuccess;

export const getGetDevicesDeviceIdSessionsSessionIdRecordsFilterValuesUrl = (
	deviceId: number,
	sessionId: number,
	...
	return stringifiedParams.length > 0
		? `/api/devices/${deviceId}/sessions/${sessionId}/records/filter-values?${stringifiedParams}`
		: `/api/devices/${deviceId}/sessions/${sessionId}/records/filter-values`;
};

export const getDevicesDeviceIdSessionsSessionIdRecordsFilterValues = async (
	deviceId: number,
	sessionId: number,
	params?: GetDevicesDeviceIdSessionsSessionIdRecordsFilterValuesParams,
	options?: RequestInit,
): Promise<getDevicesDeviceIdSessionsSessionIdRecordsFilterValuesResponse> => {
	const res = await fetch(
		getGetDevicesDeviceIdSessionsSessionIdRecordsFilterValuesUrl(
			deviceId,
			sessionId,
			params,
		),
	...
	const data: getDevicesDeviceIdSessionsSessionIdRecordsFilterValuesResponse["data"] =
		body ? JSON.parse(body) : {};
	return {
		data,
		status: res.status,
		headers: res.headers,
	} as getDevicesDeviceIdSessionsSessionIdRecordsFilterValuesResponse;
};

export const getGetDevicesDeviceIdSessionsSessionIdRecordsFilterValuesQueryKey =
	(
		deviceId: number,
		sessionId: number,
		params?: GetDevicesDeviceIdSessionsSessionIdRecordsFilterValuesParams,
...
export const getGetDevicesDeviceIdSessionsSessionIdRecordsFilterValuesQueryOptions =
	<
		TData = Awaited<
			ReturnType<typeof getDevicesDeviceIdSessionsSessionIdRecordsFilterValues>
		>,
		TError = unknown,
	>(
		deviceId: number,
		...
		options?: {
			query?: Partial<
				UseQueryOptions<
					Awaited<
						ReturnType<
							typeof getDevicesDeviceIdSessionsSessionIdRecordsFilterValues
						>
					>,
					TError,
					TData
		...
		const queryKey =
			queryOptions?.queryKey ??
			getGetDevicesDeviceIdSessionsSessionIdRecordsFilterValuesQueryKey(
				deviceId,
				sessionId,
				params,
			);
		...
		const queryFn: QueryFunction<
			...
			>
		> = ({ signal }) =>
			getDevicesDeviceIdSessionsSessionIdRecordsFilterValues(
				deviceId,
				sessionId,
				params,
				{ signal, ...fetchOptions },
...
export type GetDevicesDeviceIdSessionsSessionIdRecordsFilterValuesQueryResult =
	NonNullable<
		Awaited<
			ReturnType<typeof getDevicesDeviceIdSessionsSessionIdRecordsFilterValues>
		>
	>;
export type GetDevicesDeviceIdSessionsSessionIdRecordsFilterValuesQueryError =
	unknown;

export function useGetDevicesDeviceIdSessionsSessionIdRecordsFilterValues<
	TData = Awaited<
		ReturnType<typeof getDevicesDeviceIdSessionsSessionIdRecordsFilterValues>
	>,
	TError = unknown,
...
>(
	...
	const queryOptions =
		getGetDevicesDeviceIdSessionsSessionIdRecordsFilterValuesQueryOptions(
			deviceId,
			sessionId,
			params,
			options,
...
export const invalidateGetDevicesDeviceIdSessionsSessionIdRecordsFilterValues =
	async (
		queryClient: QueryClient,
		deviceId: number,
		sessionId: number,
	...
	faker.helpers.arrayElement([
		{
			actions: Array.from(
				...
				previousPath: faker.helpers.arrayElement([
					faker.helpers.arrayElement([
						faker.string.alpha({ length: { min: 10, max: 20 } }),
						null,
					]),
...
export const getGetDeviceMockHandler = (
	overrideResponse?:
		...
		| ((
				info: Parameters<Parameters<typeof http.get>[1]>[0],
		  ) => Promise<GetDeviceResponse> | GetDeviceResponse),
	options?: RequestHandlerOptions,
) => {
	return http.get(
		"*/devices/:deviceId",
...
export const getGetDevicesDeviceIdSessionsSessionIdRecordsFilterMetadataMockHandler =
	(
		overrideResponse?:
			| FilterMetadataResponse
			| ((
...
export const getGetDevicesDeviceIdSessionsSessionIdRecordsFilterValuesMockHandler =
	(
		overrideResponse?:
			| FilterValuesResponse
			| ((
