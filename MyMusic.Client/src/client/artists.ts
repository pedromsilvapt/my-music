...
export type listArtistsResponseComposite = listArtistsResponse200;

export type listArtistsResponse = listArtistsResponseComposite & {
    headers: Headers;
};
...
export const getListArtistsMockHandler = (
    ...
    return http.get("*/artists", async (info) => {
        await delay(1000);
