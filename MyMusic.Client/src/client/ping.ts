...
export const getPingQueryOptions = <TData = Awaited<ReturnType<typeof ping>>, TError = unknown>( options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof ping>>, TError, TData>>, fetch?: RequestInit}
) => {
...
const {query: queryOptions, fetch: fetchOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getPingQueryKey();
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof ping>>> = ({ signal }) => ping({ signal, ...fetchOptions });
...
export function usePing<TData = Awaited<ReturnType<typeof ping>>, TError = unknown>(
  options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof ping>>, TError, TData>>, fetch?: RequestInit}
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
...
export const getPingMockHandler = (overrideResponse?: void | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<void> | void), options?: RequestHandlerOptions) => {
  return http.get('*/ping', async (info: Parameters<Parameters<typeof http.get>[1]>[0]) => {
