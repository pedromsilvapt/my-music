# device-path-rename Specification

## Purpose

Defines how the server recalculates DevicePath on metadata changes and how clients handle file renames during sync downloads.
