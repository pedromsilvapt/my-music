    ...
    IImageComparisonService? imageComparisonService = null)
{
    ...
    /// <summary>
    /// Creates a metadata diff synchronously (for cases where image comparison isn't needed).
    /// </summary>
    public MetadataDiffModel CreateDiff(Song song, SourceSong sourceSong)
    {
        var diff = new MetadataDiffModel();
