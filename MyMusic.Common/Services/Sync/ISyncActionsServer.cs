...
public interface ISyncActionsServer
{
    ...
    Task<DeviceSyncSessionRecord> ActionSkipped(string filePath, long? songId = null, DateTime? modifiedAt = null, string? reason = null, CancellationToken cancellationToken = default);
    Task<DeviceSyncSessionRecord> ActionConflict(string filePath, DateTime localModifiedAt, DateTime serverModifiedAt, long? songId = null, string? reason = null, CancellationToken cancellationToken = default);
    Task<DeviceSyncSessionRecord> ActionUpdateTimestamp(string filePath, DateTime newTimestamp, long? songId = null, string? reason = null, CancellationToken cancellationToken = default);
