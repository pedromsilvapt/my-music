...
namespace MyMusic.Common.Migrations
{
    ...
    [Migration("20260724195423_AddDeviceSyncSessionRecordSessionIndexes")]
    partial class AddDeviceSyncSessionRecordSessionIndexes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyMusic.Common.Entities.AutoFetchedMetadata", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_auto_fetched_metadata");

                    b.HasIndex("SourceId")
                        .HasDatabaseName("ix_auto_fetched_metadata_source_id");

                    b.HasIndex("SongId", "FetchedAt")
                        .HasDatabaseName("ix_auto_fetched_metadata_song_id_fetched_at");

                    b.HasIndex("SongId", "Status")
                        .HasDatabaseName("ix_auto_fetched_metadata_song_id_status");

                    b.HasIndex("Status", "FetchedAt")
                        .HasDatabaseName("ix_auto_fetched_metadata_status_fetched_at");

                    b.ToTable("auto_fetched_metadata", (string)null);
                });
            ...
            modelBuilder.Entity("MyMusic.Common.Entities.Device", b =>
                {
                    ...
                    b.Property<bool>("ImportOnPurchase")
                        .HasColumnType("boolean")
                        .HasColumnName("import_on_purchase");
            ...
            modelBuilder.Entity("MyMusic.Common.Entities.DeviceSyncSessionRecord", b =>
                {
                    ...
                    b.HasIndex("SessionId", "SongId")
                        .HasDatabaseName("ix_device_sync_session_records_session_id_song_id");
            ...
            modelBuilder.Entity("MyMusic.Common.Entities.MetadataFetchTask", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_metadata_fetch_tasks");

                    b.HasIndex("SongId", "Status")
                        .HasDatabaseName("ix_metadata_fetch_tasks_song_id_status");

                    b.HasIndex("Status", "CreatedAt")
                        .HasDatabaseName("ix_metadata_fetch_tasks_status_created_at");

                    b.ToTable("metadata_fetch_tasks", (string)null);
                });

            modelBuilder.Entity("MyMusic.Common.Entities.PlayHistory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_play_histories");

                    b.HasIndex("DeviceId")
                        .HasDatabaseName("ix_play_histories_device_id");

                    b.HasIndex("SongId")
                        .HasDatabaseName("ix_play_histories_song_id");

                    b.HasIndex("OwnerId", "ClientId")
                        .IsUnique()
                        .HasDatabaseName("ix_play_histories_owner_id_client_id");

                    b.ToTable("play_histories", (string)null);
                });
            ...
            modelBuilder.Entity("MyMusic.Common.Entities.PlaylistSong", b =>
                {
                    ...
                    b.Property<bool>("SkipNextPlayback")
                        .HasColumnType("boolean")
                        .HasColumnName("skip_next_playback");

                    b.Property<long>("SongId")
                        .HasColumnType("bigint")
                        .HasColumnName("song_id");

                    b.Property<bool>("StopAfterPlayback")
                        .HasColumnType("boolean")
                        .HasColumnName("stop_after_playback");
                    ...
                    b.HasIndex("PlaylistId", "Order")
                        .HasDatabaseName("ix_playlist_songs_playlist_id_order");
            ...
            modelBuilder.Entity("MyMusic.Common.Entities.User", b =>
                {
                    ...
                    b.Property<bool>("AutoDownloadOnPurchase")
                        .HasColumnType("boolean")
                        .HasColumnName("auto_download_on_purchase");
                    ...
                    b.Property<long?>("CurrentQueueId")
                        .HasColumnType("bigint")
                        .HasColumnName("current_queue_id");
                    ...
                    b.HasIndex("CurrentQueueId")
                        .IsUnique()
                        .HasDatabaseName("ix_users_current_queue_id");

                    b.ToTable("users", (string)null);
                });

            modelBuilder.Entity("MyMusic.Common.Entities.WishlistItem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("MyMusic.Common.Entities.AutoFetchedMetadata", b =>
                {
                    b.HasOne("MyMusic.Common.Entities.Song", "Song")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_auto_fetched_metadata_songs_song_id");

                    b.HasOne("MyMusic.Common.Entities.Source", "Source")
                        .WithMany()
                        .HasForeignKey("SourceId")
                        .HasConstraintName("fk_auto_fetched_metadata_sources_source_id");
            ...
            modelBuilder.Entity("MyMusic.Common.Entities.MetadataFetchTask", b =>
                {
                    b.HasOne("MyMusic.Common.Entities.Song", "Song")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_metadata_fetch_tasks_songs_song_id");
            ...
            modelBuilder.Entity("MyMusic.Common.Entities.PlayHistory", b =>
                {
                    b.HasOne("MyMusic.Common.Entities.Device", "Device")
                        .WithMany()
                        .HasForeignKey("DeviceId")
                        .HasConstraintName("fk_play_histories_devices_device_id");
                    ...
                    b.HasOne("MyMusic.Common.Entities.User", "Owner")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_play_histories_users_owner_id");
                    ...
                    b.HasOne("MyMusic.Common.Entities.Song", "Song")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_play_histories_songs_song_id");
            ...
            modelBuilder.Entity("MyMusic.Common.Entities.User", b =>
                {
                    b.HasOne("MyMusic.Common.Entities.Playlist", "CurrentQueue")
                        .WithOne()
                        .HasForeignKey("MyMusic.Common.Entities.User", "CurrentQueueId")
                        .HasConstraintName("fk_users_playlists_current_queue_id");
            ...
            modelBuilder.Entity("MyMusic.Common.Entities.WishlistItem", b =>
                {
                    b.HasOne("MyMusic.Common.Entities.User", "Owner")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_wishlist_items_users_owner_id");
                    ...
                    b.HasOne("MyMusic.Common.Entities.Source", "Source")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_wishlist_items_sources_source_id");
